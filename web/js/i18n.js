...
const TRANSLATIONS = {
    es: {
        ...
        errTooBigDims: (name) => `"${name}" es demasiado grande (más de 150 megapíxeles) para procesarse de forma segura en el navegador — se omitió. Reduce su resolución con otra herramienta y vuelve a intentarlo.`,
    ...
    en: {
        ...
        errTooBigDims: (name) => `"${name}" is too large (over 150 megapixels) to process safely in the browser — skipped. Reduce its resolution with another tool and try again.`,
